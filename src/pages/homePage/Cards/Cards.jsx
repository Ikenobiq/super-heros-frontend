...
import {createSuperhero, getSuperheroes, updateSuperhero} from "../../../fetch/fetch";
...
const Card = ({superheroNickname}) => {
        ...
        const byNickname = superhero => superhero.nickname.toLowerCase().includes(superheroNickname)
        ...
        return (
            <div className="container">
                ...
                <Pagination currentPage={currentPage} onPageChange={onPageChanged} totalCount={totalCount}
                            pageSize={PAGE_SIZE}/>
                {superhero && <SelectedHero superhero={superhero} onSuperheroChange={handleSuperheroChange}
